    ...
    <div class="container">
      <div class="text-center">
        <div id="admin-froms" class="border rounded p-2 mb-4">
          ...
          <tbody id="admin-table">
            <?php
              ...
              <input type="hidden" name="ID" value="'.$wiersz['ID_formularza'].'"><input type="submit" name="results" value="Pobierz wyniki" class="btn btn-primary"></td></form>
        ...
        <div id="admin-froms" class="border rounded p-2">  
          ...
          <a type="button" class="btn btn-primary m-3" href="add-form.php">Dodaj nową</a>
        </div>        
      </div>
    </div>
